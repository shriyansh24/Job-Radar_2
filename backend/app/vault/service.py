...
class VaultService:
    ...
    async def _get_owned_resource(
        ...
        """Fetch a resource ensuring it belongs to the user."""
        # Using getattr to make mypy happy since it doesn't know about Base subclass columns
    ...
    async def update_resume(
        ...
        *,
        ...
        resume = await self._get_owned_resource(
            ResumeVersion, resume_id, user_id, "Resume"
        )
    ...
    async def update_cover_letter(
        ...
        *,
        ...
        letter = await self._get_owned_resource(
            CoverLetter, letter_id, user_id, "Cover letter"
        )
