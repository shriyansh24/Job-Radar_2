...
class VaultService:
    ...
    async def _get_owned_resource(
        self, model: type[T], resource_id: uuid.UUID, user_id: uuid.UUID, resource_name: str
    ) -> T:
    ...
    async def update_resume(
        ...
        *,
        ...
        resume = await self._get_owned_resource(ResumeVersion, resume_id, user_id, "Resume")
    ...
    async def update_cover_letter(
        ...
        *,
        ...
        letter = await self._get_owned_resource(CoverLetter, letter_id, user_id, "Cover letter")
