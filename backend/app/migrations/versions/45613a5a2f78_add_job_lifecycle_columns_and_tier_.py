...
def upgrade() -> None:
    ...
    op.add_column('scraper_runs', sa.Column('targets_attempted', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('scraper_runs', sa.Column('targets_succeeded', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('scraper_runs', sa.Column('targets_failed', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('scraper_runs', sa.Column('tier_0_count', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('scraper_runs', sa.Column('tier_1_count', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('scraper_runs', sa.Column('tier_2_count', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('scraper_runs', sa.Column('tier_3_count', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('scraper_runs', sa.Column('tier_api_count', sa.Integer(), nullable=False, server_default='0'))
