# DEPRECATED: This skill has moved to core/personas/planner (mode: code)
# See core/personas/planner/SKILL.md for full content

This skill is now a mode of the planner persona.
Please use: core/personas/planner with mode: code
