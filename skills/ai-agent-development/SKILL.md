# DEPRECATED: This skill has moved to domain/ai-agents
# See domain/ai-agents/SKILL.md for full content

This skill has been consolidated into the AI agents domain.
Please use: domain/ai-agents
