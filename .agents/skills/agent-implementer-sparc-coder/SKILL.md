# DEPRECATED: This skill has moved to core/personas/coder (mode: sparc)
# See core/personas/coder/SKILL.md for full content

This skill is now a mode of the coder persona.
Please use: core/personas/coder with mode: sparc
capabilities:
  - code-generation
  - test-implementation
  - refactoring
