# DEPRECATED: This skill has moved to domain/mobile
# See domain/mobile/SKILL.md for full content

This skill has been consolidated into the mobile domain.
Please use: domain/mobile
  keywords:
    - "react native"
    - "mobile app"
    - "ios app"
