...
- **Evidence:** `backend/tests/unit/test_model_contracts.py`, `backend/app/migrations/versions/20260321_db_audit_fixes.py`
- **Status:** FIXED
...
- **Evidence:** `backend/tests/unit/test_database.py`
- **Status:** FIXED
...
- **Evidence:** `backend/tests/unit/test_embedding_service.py`
- **Status:** FIXED
...
- **Evidence:** `backend/tests/unit/test_migrations.py`
- **Status:** FIXED
